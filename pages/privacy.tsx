    ...
    return(
        <div className='flex items-center p-2 justify-center '>
            <div style={{height:'650px'}} className='p-3 mt-3 font-mono text-black flex-col bg-white w-full lg:w-2/5  rounded-lg overflow-y-scroll'>
                ...
                <p className='mt-3 text-2xl'>Types of Data Collected</p>
                ...
                <p className='mt-3'> 
                    ...
                    You can instruct your browser to refuse all cookies or to indicate when a cookie is being sent. However, if you do not accept cookies, you may not be able to use some portions of our Service. You can learn more how to manage cookies in the <a className='text-blue-600 hover:underline' href='https://privacypolicies.com/blog/how-to-delete-cookies/'>Browser Cookies Guide.</a>
                </p>
                <p className='mt-3'>
                ...
                <p className='mt-3 text-2xl'>Usage of Data</p>
                <p className='mt-3'>
                ...
                <p className='mt-3'>
                Chillatom will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.
                </p>
                <p className='mt-3 text-2xl'>
                Disclosure Of Data
                </p>
                ...
                <p className='mt-3 '>
                Chillatom may disclose your Personal Data in the good faith belief that such action is necessary to:
                </p>
                <p className='mt-2 ml-5'>
